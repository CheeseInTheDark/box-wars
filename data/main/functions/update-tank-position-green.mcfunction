...
execute if entity @p[tag=driver,tag=green,nbt={SelectedItemSlot:0}] at @p[tag=driver,tag=green] run tp @p[tag=driver,tag=green] ~ ~ ~ ~-6 ~
...
function main:movement/update-driver-position-green